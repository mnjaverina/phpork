    ...
    <form class="form-horizontal col-xs-10 col-sm-10 col-md-10 col-lg-10"  method="post" action="/phpork/out" style="width:50%; float:right;"> 
      ...
      <div class="table-responsive" style="margin: 15%; margin-top: 3%; padding: 2%;">
        ...
        <table class="table">
          ...
          <tbody>
            <tr>
              <th scope="row" name="parentage">Parentage</td>
              <td><input id="a1" type="radio" name="radio" value="parentage_NOT_record"></td>
              <td><input id="a2" type="radio" name="radio" value="parentage_save_local"></td>
              <td><input id="a3" type="radio" name="radio" value="parentage_keep_private"></td>
              <td><input id="a4" type="radio" name="radio" value="parentage_open_data"></td>
            </tr>
            <tr>
              <th scope="row" name="movement">Movement</td>
              <td><input id="b1" type="radio" name="radio" value="movement_NOT_record"></td>
              <td><input id="b2" type="radio" name="radio" value="movement_save_local"></td>
              <td><input id="b3" type="radio" name="radio" value="movement_keep_private"></td>
              <td><input id="b4" type="radio" name="radio" value="movement_open_data"></td>
            </tr>
            <tr>
              <th scope="row" name="feeds">Feeds</td>
              <td><input id="c1" type="radio" name="radio" value="feeds_NOT_record"></td>
              <td><input id="c2" type="radio" name="radio" value="feeds_save_local"></td>
              <td><input id="c3" type="radio" name="radio" value="feeds_keep_private"></td>
              <td><input id="c4" type="radio" name="radio" value="feeds_open_data"></td>
            </tr>
            <tr>
              <th scope="row" name="vitasup">Vitamins and Supplements</td>
              <td><input id="d1" type="radio" name="radio" value="vitasup_NOT_record"></td>
              <td><input id="d2" type="radio" name="radio" value="vitasup_save_local"></td>
              <td><input id="d3" type="radio" name="radio" value="vitasup_keep_private"></td>
              <td><input id="d4" type="radio" name="radio" value="vitasup_open_data"></td>
            </tr>
            <tr>
              <th scope="row" name="medicine">Medicine</td>
              <td><input id="e1" type="radio" name="radio" value="medicine_NOT_record"></td>
              <td><input id="e2" type="radio" name="radio" value="medicine_save_local"></td>
              <td><input id="e3" type="radio" name="radio" value="medicine_keep_private"></td>
              <td><input id="e4" type="radio" name="radio" value="medicine_open_data"></td>
            </tr>
            <tr>
              <th scope="row" name="water">Water</td>
              <td><input id="f1" type="radio" name="radio" value="water_NOT_record"></td>
              <td><input id="f2" type="radio" name="radio" value="water_save_local"></td>
              <td><input id="f3" type="radio" name="radio" value="water_keep_private"></td>
              <td><input id="f4" type="radio" name="radio" value="water_open_data"></td>
            </tr>
            <tr>
              <th scope="row" name="prodinfo">Production Information</td>
              <td><input id="g1" type="radio" name="radio" value="prodinfo_NOT_record"></td>
              <td><input id="g2" type="radio" name="radio" value="prodinfo_save_local"></td>
              <td><input id="g3" type="radio" name="radio" value="prodinfo_keep_private"></td>
              <td><input id="g4" type="radio" name="radio" value="prodinfo_open_data"></td>
            </tr>
            <tr>
              <th scope="row" name="people">People</td>
              <td><input id="h1" type="radio" name="radio" value="people_NOT_record"></td>
              <td><input id="h2" type="radio" name="radio" value="people_save_local"></td>
              <td><input id="h3" type="radio" name="radio" value="people_keep_private"></td>
              <td><input id="h4" type="radio" name="radio" value="people_open_data"></td>
            </tr>
          </tbody>
        </table>
      </div>
